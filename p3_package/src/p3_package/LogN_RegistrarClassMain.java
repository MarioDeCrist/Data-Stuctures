...
public class LogN_RegistrarClassMain
   {
    /**
    ...
    public static void main(String[] args)
       {
        LogN_RegistrarClass rc = uploadData( "inData.txt", true ); 
        StudentClass[] scList = new StudentClass[ INIT_CAPACITY ];
        int listSize = 50;

        System.out.println( "Running Merge Sort" );
        scList = rc.runMergeSort();        
        printList( scList, listSize );
        
        System.out.println( "Running Quick Sort" );
        scList = rc.runQuickSort();        
        printList( scList, listSize );
           
        System.out.println( "Dumping Registrar Class List (Unsorted)" );
     ...
     */
    public static LogN_RegistrarClass uploadData( String fileName, boolean display )
       {
        LogN_RegistrarClass uploadData = new LogN_RegistrarClass();
